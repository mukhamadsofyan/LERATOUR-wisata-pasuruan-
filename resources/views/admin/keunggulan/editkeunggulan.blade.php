...
<body>
        ...
        <div class="dashboard -is-sidebar-visible js-dashboard">
            ...
            <div class="dashboard__content">
                ...
                <div class="dashboard__content_content">
                    ...
                    <div class="mb-60">
                        <h1 class="text-30">Manajemen Keunggulan</h1>
                        <p class="">Kelola data keunggulan yang ditampilkan pada website LERATOUR.</p>
                    </div>

                    <div class="rounded-12 bg-white shadow-2 px-40 pt-40 pb-30">
                        <h5 class="text-20 fw-500 mb-30">Edit Keunggulan</h5>

                        <form method="POST" action="{{ route('admin.updatekeunggulan', $keunggulan->id) }}"
                            ...
                            <div class="contactForm row y-gap-30">
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <input type="text" name="title_keunggulan"
                                            value="{{ old('title_keunggulan', $keunggulan->title_keunggulan) }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <textarea name="deskripsi_keunggulan" rows="8">{{ old('deskripsi_keunggulan', $keunggulan->deskripsi_keunggulan) }}</textarea>
                                        <label class="lh-1 text-16 text-light-1">
                                            Deskripsi Keunggulan
                                        </label>
                                    </div>
                                ...
                                {{-- LOGO / ICON --}}
                                <div class="col-12">
                                    <h4 class="text-18 fw-500 mb-20">Logo / Icon Keunggulan</h4>
                                    ...
                                    <div class="row x-gap-20 y-gap">
                                        <div class="col-auto">
                                            <div class="size-200 rounded-12 border-dash-1 bg-accent-1-05 flex-center flex-column"
                                                ...
                                                <input type="file" name="logo_icon" accept="image/*"
                                                    ...
                                                    onchange="previewKeunggulanIcon(event)">
                                        ...
                                        <div class="col-auto">
                                            <img id="previewKeunggulanIcon"
                                                src="{{ $keunggulan->logo_icon ? asset('storage/' . $keunggulan->logo_icon) : '' }}"
                                                class="size-200 rounded-12 object-contain"
                                                style="{{ $keunggulan->logo_icon ? '' : 'display:none;' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="text-14 text-light-1">
                                        Konten ini akan ditampilkan pada halaman utama sebagai alasan
                                        pengunjung memilih website ini.
                                    </div>
                                </div>
    ...
    @include('layout.js')
    <script>
        function previewKeunggulanIcon(event) {
            const input = event.target;
            const preview = document.getElementById('previewKeunggulanIcon');
