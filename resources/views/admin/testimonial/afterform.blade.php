                ...
                <div class="row">
                    <div class="wrapper">
                        <div class="card">
                            ...
                            <p class="subtitle">
                                Terima kasih telah memberikan testimoni dan kepercayaan Anda kepada layanan kami
                            </p>
                            ...
                            <div class="step-box">
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Verifikasi Testimoni</h4>
                                        <p>Tim kami akan memeriksa isi testimoni Anda untuk memastikan sesuai dengan
                                            ketentuan</p>
                                    </div>
                                </div>
                                ...
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Publikasi</h4>
                                        <p>Jika sudah lolos verifikasi, testimoni Anda akan dipublikasikan di halaman
                                            website kami</p>
                                    </div>
                                </div>
                                ...
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Apresiasi</h4>
                                        <p>Masukan dan dukungan Anda membantu kami terus meningkatkan kualitas layanan
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="note">
                                ...
                                <p><strong>Notifikasi:</strong> Kami akan menghubungi Anda jika ada hal yang perlu
                                    dikonfirmasi</p>
                                <p><strong>Kerahasiaan:</strong> Data pribadi Anda akan tetap aman dan tidak disebarkan
                                </p>
                            </div>
