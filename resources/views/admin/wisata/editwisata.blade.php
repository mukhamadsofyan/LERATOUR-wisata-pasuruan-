                    ...
                    <div class="rounded-12 bg-white shadow-2 px-40 pt-40 pb-30">
                        ...
                        <form method="POST" action="{{ route('admin.updatewisata', $wisata->id) }}"
                            ...
                            <div class="contactForm row y-gap-30">
                                        ...
                                        <select name="kategori_wisata" required>
                                            ...
                                            @foreach ($kategori as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('kategori_wisata', $wisata->kategori_wisata) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->kategori }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <textarea name="deskripsi_wisata" rows="8" required>{{ old('deskripsi_wisata', $wisata->deskripsi_wisata) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <textarea name="fasilitas" rows="5">{{ old('fasilitas', $wisata->fasilitas) }}</textarea>
