            ...
            <div class="dashboard__content">
                ...
                <div class="dashboard__content_content">
                    ...
                    <div class="rounded-12 bg-white shadow-2 px-40 pt-40 pb-30">
                        <h5 class="text-20 fw-500 mb-30">Tambah Wisata</h5>

                        <form method="POST" action="{{ route('admin.insertwisata') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="contactForm row y-gap-30">
                                ...
                                <div class="col-md-6">
                                    <div class="form-input">
                                        <input type="text" name="harga_tiket" value="{{ old('harga_tiket') }}"
                                            required>
                                        <label class="lh-1 text-16 text-light-1">Harga Tiket</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-input">
                                        <input type="text" name="jam_buka" value="{{ old('jam_buka') }}">
                                        <label class="lh-1 text-16 text-light-1">Jam Buka</label>
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-input">
                                        <input type="text" name="jam_tutup" value="{{ old('jam_tutup') }}">
                                        <label class="lh-1 text-16 text-light-1">Jam Tutup</label>
                                    </div>
                                </div>

                                {{-- PETA LOKASI --}}
                                <div class="col-12">
                                    <h4 class="text-18 fw-500 mb-10">Lokasi Wisata (Peta)</h4>

                                    <input type="text" id="search-location" class="form-control mb-10"
                                    ...
                                    <div class="text-14 mt-10 text-light-1">
                                        Ketik lokasi, klik peta, atau geser marker
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <textarea name="deskripsi_wisata" rows="8" required>{{ old('deskripsi_wisata') }}</textarea>
                                        <label class="lh-1 text-16 text-light-1">Deskripsi Wisata</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-input">
                                        <textarea name="fasilitas" rows="5">{{ old('fasilitas') }}</textarea>
                                        <label class="lh-1 text-16 text-light-1">Fasilitas</label>
                                    </div>
                                </div>

                                {{-- FOTO --}}
                                <div class="col-12">
                                    <h4 class="text-18 fw-500 mb-20">Foto Wisata</h4>


                                    <div class="d-flex gap-20 align-items-start">
                                        ...
                                        <!-- PREVIEW BOX -->
                                        <div id="previewWrapper" class="size-200 rounded-12 border-1 flex-center"
