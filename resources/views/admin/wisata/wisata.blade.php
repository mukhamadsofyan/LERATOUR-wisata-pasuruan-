        ...
        <div class="dashboard -is-sidebar-visible js-dashboard">
            ...
            <div class="dashboard__content">
                ...
                <div class="dashboard__content_content">
                    ...
                    <h1 class="text-30">Wisata</h1>
                    <p class="">Kumpulan destinasi wisata pilihan untuk perjalananmu.</p>

                    <div class="pt-40">
                        <center><a href="{{ route('admin.tambahwisata') }}"><button
                                            ...
                                            <tbody>
                                                @forelse ($wisata as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Rp
                                                            {{ is_numeric($item->harga_tiket) ? number_format($item->harga_tiket, 0, ',', '.') : '-' }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex items-center">
                                                                <a href="{{ route('admin.editwisata', $item->id) }}"
                                                                ...
                                                                <form id="delete-form-{{ $item->id }}"
                                                                    action="{{ route('admin.hapuswisata', $item->id) }}"
                                    ...
                                    @if ($wisata->hasPages())
                                        <div class="pagination justify-center mt-30">
                                            ...
                                            <div class="pagination__count">
                                                @foreach ($wisata->links()->elements[0] as $page => $url)
                                        ...
                                        <div class="text-14 text-center mt-20">
                                            Showing {{ $wisata->firstItem() }} – {{ $wisata->lastItem() }}
                                            of {{ $wisata->total() }} results
                                        </div>
                                    @endif
