                ...
                <div class="row">
                    <div class="wrapper">
                        <div class="card">
                            ...
                            <!-- TITLE -->
                            <h1>Foto Galeri Berhasil Dikirim!</h1>
                            <p class="subtitle">
                                Terima kasih telah berbagi momen perjalanan Anda melalui galeri LERATour
                            </p>
                            ...
                            <div class="step-box">
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Verifikasi Foto</h4>
                                        <p>
                                            Tim kami akan meninjau foto galeri yang Anda kirim untuk memastikan
                                ...
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Publikasi Galeri</h4>
                                        <p>
                                            Setelah disetujui admin, foto Anda akan ditampilkan
                                            di halaman galeri LERATour
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="step">
                                    ...
                                    <div>
                                        <h4>Inspirasi Wisata</h4>
                                        <p>
                                            Foto yang Anda bagikan dapat menjadi inspirasi
                                            bagi pengunjung lain untuk menjelajahi destinasi wisata
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="note">
                                ...
                                <p>
                                    ...
                                    Verifikasi galeri biasanya membutuhkan waktu 1–2 hari kerja
                                </p>
                                <p>
                                    <strong>Status Galeri:</strong>
                                    Foto akan ditampilkan setelah disetujui oleh admin
                                </p>
                                <p>
                                    <strong>Keamanan:</strong>
                                    Foto dan data Anda akan dijaga dan tidak disalahgunakan
                                </p>
                            </div>

                            <!-- BUTTON -->
                            <a href="/pages/galeri-foto" class="btn-back">
                                Kembali ke Galeri
                            </a>
