                ...
                <div class="row">
                    <div data-anim-child="fade" class="col-lg-12">
                        ...
                        <div class="bg-white rounded-12 shadow-2 py-15 px-20">
                            Bagikan Momen Liburan Anda dengan Mengirimkan Foto Galeri!
                        </div>

                        <div class="bg-white rounded-12 shadow-2 py-30 px-30 md:py-20 md:px-20 mt-30">
                            <h2 class="text-30 md:text-24 fw-700">Form Galeri</h2>
                            <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data"
                                class="row y-gap-30 contactForm pt-30">
                                @csrf

                                <!-- NAMA PENGUNJUNG -->
                                <div class="col-12">
                                    <div class="form-input">
                                        <input type="text" name="uploader_name" placeholder="Nama Pengunjung">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row x-gap-20 y-gap align-items-start">
                                        ...
                                        <!-- PREVIEW -->
                                        <div class="col-auto">
                                            <img id="galleryPreview" class="size-200 rounded-12 object-cover"
                                                style="display:none;">
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="text-14 text-light-1">
                                        Foto yang Anda kirim akan ditinjau terlebih dahulu oleh admin sebelum
    ...
    <script>
        function previewGalleryImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                // Validasi aman (optional tapi bagus)
